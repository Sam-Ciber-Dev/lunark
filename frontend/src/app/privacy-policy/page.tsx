  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-sm prose-invert max-w-none space-y-8">
        <div className="rounded-lg border border-border/40 bg-card/50 p-8 space-y-4 text-sm text-muted-foreground leading-relaxed">
          <p>
            Lunark (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, share, and protect your personal data when you visit our website, make a purchase, or interact with our services.
          </p>
          <p>
            We comply with the General Data Protection Regulation (GDPR) — Regulation (EU) 2016/679 — and applicable Portuguese data protection law (Lei n.º 58/2019).
          </p>
        </div>
