  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4">Terms & Conditions</h1>
      ...
      <div className="space-y-8">
        <div className="rounded-lg border border-border/40 bg-card/50 p-8 text-sm text-muted-foreground leading-relaxed space-y-2">
          <p>Welcome to Lunark. These Terms & Conditions (&quot;Terms&quot;) govern your use of our website and services. By accessing or using our website, creating an account, or making a purchase, you agree to be bound by these Terms.</p>
          <p>Please read them carefully. If you do not agree with any part of these Terms, you should not use our services.</p>
        </div>
