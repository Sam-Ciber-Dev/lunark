...
export const pt: Dictionary = {
  ...
  auth: {
    ...
    accountBanned: "Esta conta foi banida pela administração.",
    accountBannedReason: "Esta conta foi banida pela administração. Motivo:",
    emailBanned: "Este email está bloqueado de criar novas contas.",
    emailBannedReason: "Este email está bloqueado de criar novas contas. Motivo:",
