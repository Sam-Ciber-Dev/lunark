...
export const en = {
  ...
  auth: {
    ...
    registerSubtitle: "Create your Lunark account to get started.",
    or: "or",
    ...
    resendIn: "Resend in",
    googlePrefilled: "Google account info applied. Set your password below.",
    ...
    accountBanned: "This account has been banned by the administrator.",
    accountBannedReason: "This account has been banned by the administrator. Reason:",
    emailBanned: "This email is blocked from creating new accounts.",
    emailBannedReason: "This email is blocked from creating new accounts. Reason:",
