...
if(isset($_POST['email']) || isset($_POST['senha'])) { // Verifica se as variáveis 'email' e 'senha' estão definidas no array $_POST, tendo em conta que é o nome das inputbox no exemplo abaixo 
    ...
    if(strlen($_POST['email']) == 0) { 
        ...
        $sql_code = "SELECT * FROM users WHERE email = '$email' AND senha = '$senha'"; // iremos selecionar a tabela utilizadores e ver se no campo email e no campo senha existe o utilizador que colocamos nas inputbox
    ...
    <div class="main">
        ...
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container" id="switch-c1">
                ...
                <button class="switch__button button switch-btn"><a href="registo.php" style="color:white;">Registar</button>
                <br>
                <a href="staff.php" style="color:black;">Admin</a>
                <br>
